...
const PRODUCT_IMAGE = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-OevSKr4d6tucYjpeghAxq8EXOU2pqd.png"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="font-bold text-foreground">Rs. 600.00</span>
